if [ ! -f "constructorASTCUP/InputsDiver/$1.jn" ]; then
...
echo "Compilando constructorASTCUP/InputsDiver/$1.jn a constructorASTCUP/$1.wat..."
java -cp "../cup.jar:." constructorast.Main InputsDiver/$1.jn $1.wat >> ../CompilationLog.txt
